...
ctx.shadowBlur = 40;
ctx.font = 'bold 100px "Fredoka", "Arial Rounded MT Bold", Arial, sans-serif';
ctx.fillStyle = '#FFFFFF';
...
ctx.fillStyle = '#FFD700';
ctx.font = 'bold 90px "Fredoka", "Arial Rounded MT Bold", Arial, sans-serif';
...
// Subtítulo
ctx.font = 'bold 32px "Fredoka", Arial, sans-serif';
ctx.fillStyle = '#FFFFFF';
...
// Texto inferior
ctx.font = '22px "Fredoka", Arial, sans-serif';
